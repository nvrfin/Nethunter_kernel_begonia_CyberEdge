...
if [[ $1 = "-t" || $1 = "--tools" ]]; then
        ...
        apt-get install -y llvm libtool  automake autoconf libarchive-tools patchelf
        apt update
        apt upgrade -y
...
if [[ $1 = "-b" || $1 = "--build" ]]; then
	...
	elif ! git clone -q https://github.com/nvrfin/Anykernel -b begonia-vic ; then
